...
from pyspark.sql.functions import col, count, avg, month, unix_timestamp, when, lit
...
spark = SparkSession.builder \
    ...
    .config("spark.mongodb.input.uri", "mongodb://mongo_db:27017/Neurotask.tareas") \
    .config("spark.mongodb.output.uri", "mongodb://mongo_db:27017/Neurotask.analisis_usuario") \
    .getOrCreate()
...
tareas_mes_actual = df.filter((col("estado") == "Hecho") & (col("mes_completado") == current_month)) \
